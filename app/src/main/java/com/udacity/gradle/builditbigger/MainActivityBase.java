...
public class MainActivityBase extends AppCompatActivity implements JokeCallback {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.tt.androidjokes.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.tt.androidjokes.R.id.action_settings) {
            return true;
        }
    ...
    public void onError(Exception e) {
        Toast.makeText(this, com.tt.androidjokes.R.string.empy_joke_error, Toast.LENGTH_LONG).show();
    }
}
